...
export const addToCart = createAsyncThunk(
  ...
  async (productData, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.post(`${BASE_URL}/cart/add`, productData, {
        headers: {
...
export const getcartCount = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await axios.get(`${BASE_URL}/cart/cart-count`, {
        headers: {
      ...
      return rejectWithValue(
        error.response?.data || "Failed to get cart count"
      );
    }
  }
);
