// components/HomeCardTable/HomeCardTableRow.jsx
    ...
    <div className="bg-white border border-gray-100 rounded-xl shadow-sm p-5 flex flex-col transition-all hover:shadow-md h-full">
      ...
      <div className="flex-1 mb-4">
        ...
        <div className="text-xs text-gray-500">
          <p className="truncate">Link: {homeCard.buttonLink}</p>
          <p>Created: {new Date(homeCard.createdAt || Date.now()).toLocaleDateString()}</p>
        </div>
      </div>
