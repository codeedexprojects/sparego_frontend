// components/HomeCardTable/HomeCardModal.jsx
"use client";
  ...
  useEffect(() => {
    if (homeCard) {
      setFormData({
        ...
        buttonLink: homeCard.buttonLink || "",
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-50 p-4">
      <div className="bg-white w-full max-w-md p-6 rounded-xl shadow-lg max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium mb-2 text-gray-700">Button Link</label>
            <input
              type="url"
              name="buttonLink"
