...
const SubSubCategoryList = ({ categories, loading, error, onEdit, onDelete, onAddCategory, onToggleStatus }) => {
  if (loading) {
    return (
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
        <div className="text-center py-12">
          ...
          <p className="mt-3 text-gray-600">Loading sub-sub-categories...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
        <div className="text-center py-12">
          ...
          <h3 className="mt-2 text-sm font-medium text-gray-900">Error loading sub-sub-categories</h3>
    ...
    return (
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
        <div className="text-center py-12">
          ...
          <h3 className="mt-2 text-sm font-medium text-gray-900">No sub-sub-categories</h3>
          <p className="mt-1 text-sm text-gray-500">Get started by creating your first sub-sub-category.</p>
          <button
...
// Individual Sub-sub-category Row Component
const SubSubCategoryRow = ({ subSubCategory, onEdit, onDelete, onToggleStatus }) => (
  <tr className="hover:bg-gray-50 transition-colors duration-150">
        ...
        <div className="flex-shrink-0 h-10 w-10">
          {subSubCategory.image ? (
            <img 
              ...
              src={subSubCategory.image.startsWith('http') ? subSubCategory.image : `${IMG_URL}/${subSubCategory.image}`} 
    ...
    <td className="px-6 py-4 whitespace-nowrap">
      <span className="inline-flex items-center text-xs font-medium">
        {subSubCategory.section?.title || "Spare Parts"}
      </span>
    </td>
    <td className="px-6 py-4 whitespace-nowrap">
    ...
    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
      <div className="flex justify-end space-x-2">
        ...
        {onToggleStatus && (
          <button
            onClick={() => onToggleStatus(subSubCategory)}
          ...
          >
            {subSubCategory.isActive ? 'Deactivate' : 'Activate'}
          </button>
        )}
        <button
          onClick={() => onDelete(subSubCategory)}
